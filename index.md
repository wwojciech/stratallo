...
|----|----|
| [`opt()`](https://wwojciech.github.io/junco/reference/opt.md) | Optimum allocation with a fixed total sample size. |
| [`optcost()`](https://wwojciech.github.io/junco/reference/optcost.md) | Minimum-cost allocation under a variance constraint. |
| [`dopt()`](https://wwojciech.github.io/junco/reference/dopt.md) | Multi-domain optimum allocation with controlled precision. |
