...
allocations in stratified sampling designs. The implemented methods solve
several classical optimization problems arising in survey design using **exact
analytical algorithms**, rather than relying on numerical approximations.

The package supports a variety of practical constraints, including lower and
upper bounds on stratum sample sizes, cost constraints, and multi-domain
precision control.
...
For a detailed description of the allocation problems and algorithms, see the
package vignette.
