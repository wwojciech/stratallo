...
context, the optimal allocation is in the classical Tschuprow-Neyman's sense and
...
stratified estimator is of the following generic form:
...
simple random sampling without replacement* design in strata.
