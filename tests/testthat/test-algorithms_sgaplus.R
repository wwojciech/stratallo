...
test_that("sgaplus works well for M (reaching no bound), H = 1", {
...
test_that("sgaplus works well for M (reaching 1 bound), H = 1", {
...
test_that("sgaplus works well for M (reaching no bounds), H = 4", {
...
test_that("sgaplus works well for M (reaching 1 bound), H = 4", {
...
test_that("sgaplus works well for M (reaching 2 bounds), H = 4", {
...
test_that("sgaplus works well for M (reaching 3 bounds), H = 4", {
