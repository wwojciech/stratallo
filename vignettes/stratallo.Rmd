...
of optimum sample allocation is the Tchuprov-Neyman's sense [@Tchuprov; @neyman].
...
total of a given study variable, under constraint on total sample size. This
problem can be further complemented by imposing lower or upper bounds on sample
sizes is strata.
